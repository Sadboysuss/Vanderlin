...
/datum/crafting_recipe/roguetown/militia_flail
	name = "militia flail"
	skillcraft = /datum/skill/craft/carpentry
	reqs = list(/obj/item/rogueweapon/flail/towner, /obj/item/ingot/iron)
	tools = list(/obj/item/rogueweapon/hammer)
	req_table = TRUE
...
/datum/crafting_recipe/roguetown/woodengreatflail
	...
	skillcraft = /datum/skill/craft/carpentry
	reqs = list( /obj/item/rope, /obj/item/grown/log/tree/stick, /obj/item/grown/log/tree/small)
	tools = list(/obj/item/rogueweapon/hammer)
	req_table = TRUE
...
/datum/crafting_recipe/roguetown/bigflail
	...
	skillcraft = /datum/skill/craft/carpentry
	reqs = list(/obj/item/rope/chain,
			/obj/item/rogueweapon/thresher, /obj/item/ingot/iron)
	tools = list(/obj/item/rogueweapon/hammer)
	req_table = TRUE
...
/datum/crafting_recipe/roguetown/ironcudgel
	...
	skillcraft = /datum/skill/craft/carpentry
	reqs = list(/obj/item/grown/log/tree/small, /obj/item/ingot/iron)
	tools = list(/obj/item/rogueweapon/hammer)
	req_table = TRUE
